...
import { DELETE_SCHOOL_RESET } from "../../constants/schoolsConstants";
...
const SchoolsList = () => {
  ...
  const { error, schools } = useSelector((state) => state.allSchools);
  ...
  useEffect(() => {
    ...
    if (isDeleted) {
      ...
      navigate("/dashboard");
      dispatch({ type: DELETE_SCHOOL_RESET });
    }
    ...
    <Fragment>
      ...
      <div className="dashboard">
        ...
        <div className="schoolListContainer">
          <h1 id="schoolListHeading">{t("all_sql_r")}</h1>
